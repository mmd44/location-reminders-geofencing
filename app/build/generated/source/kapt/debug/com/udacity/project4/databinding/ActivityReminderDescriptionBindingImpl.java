...
public class ActivityReminderDescriptionBindingImpl extends ActivityReminderDescriptionBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.reminder_title_label_text, 2);
        sViewsWithIds.put(R.id.reminder_desc_label_text, 3);
        sViewsWithIds.put(R.id.reminder_location_label_text, 4);
        sViewsWithIds.put(R.id.reminder_title_value_text, 5);
        sViewsWithIds.put(R.id.reminder_desc_value_text, 6);
        sViewsWithIds.put(R.id.reminder_location_value_text, 7);
    }
    // views
    @NonNull
